...
var color = Color.fromHex("964B00") as Color;

var browntigar  = MaterialSystem.getMaterialBuilder().setName("browntigar").setColor(color).build();

browntigar.registerParts(["gear", "plate", "nugget", "ingot", "rod", "dust"] as string[]);

var molten = browntigar .registerPart("molten").getData();
molten.addDataValue("temperature", "400");
molten.addDataValue("luminosity", "10");

var block = browntigar .registerPart("block").getData();
block.addDataValue("hardness", "5");
block.addDataValue("resistance", "30");
block.addDataValue("harvestTool", "pickaxe");

var ore = browntigar.registerPart("ore").getData();
...
var armor = browntigar.registerPart("armor").getData();
