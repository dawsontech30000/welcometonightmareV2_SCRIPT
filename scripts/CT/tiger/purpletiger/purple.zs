...
var color = Color.fromHex("b042f5") as Color;

var purpletiger  = MaterialSystem.getMaterialBuilder().setName("purpletiger").setColor(color).build();

purpletiger.registerParts(["gear", "plate", "nugget", "ingot", "rod", "dust"] as string[]);

var molten = purpletiger .registerPart("molten").getData();
molten.addDataValue("temperature", "400");
molten.addDataValue("luminosity", "10");

var block = purpletiger .registerPart("block").getData();
block.addDataValue("hardness", "5");
block.addDataValue("resistance", "30");
block.addDataValue("harvestTool", "pickaxe");

var ore = purpletiger.registerPart("ore").getData();
...
var armor = purpletiger.registerPart("armor").getData();
