...
var color = Color.fromHex("2596be") as Color;

var Xaelium = MaterialSystem.getMaterialBuilder().setName("Xaelium").setColor(color).build();

Xaelium.registerParts(["gear", "plate", "nugget", "ingot", "rod", "dust"] as string[]);

var molten = Xaelium.registerPart("molten").getData();
molten.addDataValue("temperature", "400");
molten.addDataValue("luminosity", "10");

var block = Xaelium.registerPart("block").getData();
block.addDataValue("hardness", "5");
block.addDataValue("resistance", "30");
block.addDataValue("harvestTool", "pickaxe");

var ore = Xaelium.registerPart("ore").getData();
...
var armor = Xaelium.registerPart("armor").getData();
