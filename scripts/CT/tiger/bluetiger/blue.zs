...
var color = Color.fromHex("42e0f5") as Color;

var bluetiger  = MaterialSystem.getMaterialBuilder().setName("bluetiger").setColor(color).build();

bluetiger.registerParts(["gear", "plate", "nugget", "ingot", "rod", "dust"] as string[]);

var molten = bluetiger .registerPart("molten").getData();
molten.addDataValue("temperature", "400");
molten.addDataValue("luminosity", "10");

var block = bluetiger .registerPart("block").getData();
block.addDataValue("hardness", "5");
block.addDataValue("resistance", "30");
block.addDataValue("harvestTool", "pickaxe");

var ore = bluetiger.registerPart("ore").getData();
...
var armor = bluetiger.registerPart("armor").getData();
