...
var color = Color.fromHex("808080") as Color;

var graytigar  = MaterialSystem.getMaterialBuilder().setName("graytigar").setColor(color).build();

graytigar.registerParts(["gear", "plate", "nugget", "ingot", "rod", "dust"] as string[]);

var molten = graytigar .registerPart("molten").getData();
molten.addDataValue("temperature", "400");
molten.addDataValue("luminosity", "10");

var block = graytigar .registerPart("block").getData();
block.addDataValue("hardness", "5");
block.addDataValue("resistance", "30");
block.addDataValue("harvestTool", "pickaxe");

var ore = graytigar.registerPart("ore").getData();
...
var armor = graytigar.registerPart("armor").getData();
